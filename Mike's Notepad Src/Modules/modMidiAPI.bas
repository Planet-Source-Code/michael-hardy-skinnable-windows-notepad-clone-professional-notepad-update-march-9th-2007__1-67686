Attribute VB_Name = "MidiAPI"
'Michael J. Hardy's Uno Xtreme Card Game For Windows!
'Written & Created By Michael J. Hardy
'Dedicated to My Daughter (Zoe) and My Parents.
''
'Released Under the MOZILLA PUBLIC LICENSE! (MPL)
'GNU Portions By Aris
'Web Site: http://www.mikes-games.com/uno/
'Email: coolgame@fidmail.com
