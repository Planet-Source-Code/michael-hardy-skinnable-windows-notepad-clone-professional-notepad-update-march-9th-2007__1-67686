...
Private Sub Form_Load()
    ...
    For v = 0 To 9
        Temp = GetSetting("Michael Hardy Is Kool\" + App.EXEName, "FindText", "Text" + Str(v))
        If Temp <> "" Then
            ...
            End If
        End If
        Temp = GetSetting("Michael Hardy Is Kool\" + App.EXEName, "ReplaceText", "Text" + Str(v))
        If Temp <> "" Then
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    For v = 0 To 9
        If Len(Trim(cboFind.List(v))) <> 0 Then
            SaveSetting "Michael Hardy Is Kool\" + App.EXEName, "FindText", "Text" + Str(v), cboFind.List(v)
        End If
        If Len(Trim(cboReplace.List(v))) <> 0 Then
            SaveSetting "Michael Hardy Is Kool\" + App.EXEName, "ReplaceText", "Text" + Str(v), cboReplace.List(v)
        End If
    Next v
End Sub
