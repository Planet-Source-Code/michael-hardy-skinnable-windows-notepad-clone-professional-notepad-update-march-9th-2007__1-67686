...
Begin VB.Form frmDate 
   ...
   Begin VB.ListBox List1 
      Appearance      =   0  'Flat
      Height          =   2370
      ItemData        =   "frmDate.frx":014A
      Left            =   120
      List            =   "frmDate.frx":014C
      TabIndex        =   0
      Top             =   120
      Width           =   2655
   End
...
Private Sub cmdOK_Click()
    ...
    Select Case List1.ListIndex
        ...
        Case 3
            frmMain.Undo.InsertText Format(Date, "MM/DD/YYYY") + vbCrLf
        ...
        Case 6
            frmMain.Undo.InsertText WeekdayName(Weekday(Now, vbUseSystemDayOfWeek)) + "," + Chr(32) + MonthName(DatePart("M", (Now))) + Str(Day(Now)) + Str(Year(Now)) + vbCrLf
...
Private Sub Form_Load()
    ...
    List1.AddItem WeekdayName(Weekday(Now, vbUseSystemDayOfWeek)) + "," + Str(Day(Now)) + Chr(32) + MonthName(DatePart("M", (Now))) + "," + Str(Year(Now))
        List1.AddItem WeekdayName(Weekday(Now, vbUseSystemDayOfWeek)) + Chr(32) + MonthName(DatePart("M", (Now))) + Str(Day(Now)) + "," + Str(Year(Now))
